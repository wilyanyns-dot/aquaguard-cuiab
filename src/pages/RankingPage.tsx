...
const levels = [
  ...
  { name: "Prata", color: "bg-gray-400", min: 5 },
  { name: "Ouro", color: "bg-amarelo-alerta", min: 10 },
  { name: "Platina", color: "bg-primary", min: 20 },
  { name: "AquaMaster", color: "bg-turquesa", min: 25 },
];
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      <div className="gradient-header px-5 pt-12 pb-8 rounded-b-3xl">
        ...
        {/* User card */}
        <motion.div
          className="bg-primary-foreground/15 rounded-2xl p-4 backdrop-blur-sm"
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-display font-bold text-primary-foreground">#24</p>
              <span className="text-primary-foreground/70 text-xs font-body">Nível: Prata</span>
            </div>
            <div className="text-right">
              <span className="text-primary-foreground/70 text-xs font-body">Economia</span>
              <p className="text-2xl font-display font-bold text-primary-foreground">15%</p>
              <span className="text-primary-foreground/70 text-xs font-body">Desconto: R$ 18,50</span>
            </div>
          </div>
          {/* Progress bar */}
          <div className="mt-3">
      ...
      <div className="px-5 -mt-3">
          ...
          {leaderboard.map((user, i) => (
            <motion.div
              ...
              className={`flex items-center gap-3 p-3 rounded-xl transition-colors ${
                (user as any).isUser ? "bg-primary/10 border border-primary/20" : "bg-card shadow-card"
              }`}
        ...
        <div className="bg-card rounded-2xl shadow-card p-4">
          ...
          <p className="text-xs font-body text-cinza-medio mb-2">
            Vizinhos, falta apenas 2% para liberarmos o desconto comunitário de 5%!
          </p>
          <div className="h-2 bg-muted rounded-full overflow-hidden">
            <motion.div
              className="h-full rounded-full bg-verde-sucesso"
              initial={{ width: 0 }}
              animate={{ width: "98%" }}
